...
MEDIA_ROOT = '/Users/Amit/research/caReportCard/otherCafe/cafe/src/client/media/'
...
FEEDBACK_EMAIL_TO = 'Hyb Feedback <support@hybridwisdom.com>'
...
EMAIL_RECIPIENTS = ['sanjay@eecs.berkeley.edu', 
                    ...
                    'hunallen@gmail.com']
#EMAIL_RECIPIENTS=['patel.jay@berkeley.edu']
TROUBLESHOOT_EMAIL_RECIPIENTS = ['patel.jay@berkeley.edu', 'sanjay@eecs.berkeley.edu']
